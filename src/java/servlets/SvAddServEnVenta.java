...
@WebServlet(name = "SvAddServEnVenta", urlPatterns = {"/SvAddServEnVenta"})
public class SvAddServEnVenta extends HttpServlet {
...
//En el GET pide que se abra el jsp de editarUser
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        RequestDispatcher dispatcher = request.getRequestDispatcher("addServEnVenta.jsp");
