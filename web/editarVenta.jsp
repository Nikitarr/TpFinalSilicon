...
<html lang="es">
    ...
    <body>
        ...
        if(usuar == null){
            ...
            Venta venta = control.traerVenta(Integer.parseInt(Id));
            int id = venta.getNum_venta() ;
            String modoPago = venta.getModo_pago() ;
            ...
            <div class="wrapper wrapper--w680">
                <div class="card card-4">
                    <div class="card-body">
                        ...
                        <form action = "SvEditarVenta" method="POST">
                            <input type="hidden" name="id" value="<%=id%>">
                            <div class="row row-space">
                                <div class="col-2">
                                    <div class="input-group">
                                        <label class="label">Método de Pago</label>
                                        <input class="input--style-4" type="text" name="modoPago" value="<%=modoPago%>">
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="input-group">
                                        <label class="label">Fecha de la Venta</label>
                                        <div class="input-group-icon">
                                            <input class="input--style-4 js-datepicker" type="text" name="fechaVenta" value="<%=fechaVenta%>">
                            ...
                            <div class="row row-space">
                                <div class="col-2">
                                    <div class="input-group">
                                        ...
                                        <select class="input--style-4" type="combobox" name="cliente">
                                ...
                                <div class="col-2">
                                    <div class="input-group">
                                        ...
                                        <select class="input--style-4" type="combobox" name="empleado">
                                                <% for (Usuario usu1 : listaEmpleados) {%>
                                                <option value="<%=usu1.getId_user() %>"><%=usu1.getNombre()%></option>
                                            <%}%>                                           
                                        </select>
                                    </div>
                                </div>
