...
<html lang="es">
    ...
    <head>
        ...
        <!-- Title Page-->
        <title>Agregar Usuario/Empleado</title>
        ...
        <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
            <div class="wrapper wrapper--w680">
                <div class="card card-4">
                    <div class="card-body">
                        <h2 class="title">Añadir Empleado/Usuario</h2>
                        <form action = "SvAgregarUser" method="POST">
                                ...
                                <div class="row row-space">
                                    ...
                                    <div class="col-2">
                                        <div class="input-group">
                                            ...
                                            <input class="input--style-4" type="number" name="sueldo">
                                        </div>
                                    </div>
                                </div>
